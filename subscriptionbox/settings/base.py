...
ROOT_URLCONF = 'subscriptionbox.urls'
...
MIDDLEWARE = [
    ...
    'base.middleware.CheckProfileMiddleware',
]
...
#            'user_location', 'user_relationship_details',
#            'user_religion_politics', 
#            'user_actions.books'
            ],
        # from - https://developers.facebook.com/docs/graph-api/reference/user/
        #'FIELDS': [
            #'about', 'id', 'address', 'birthday',
            #'email', 'gender', 'hometown', 'location', 'name',
            #'political', 'profile_pic', 'quotes', 'relationship_status', 'religion',],
...
CART_PRODUCT_MODEL = 'base.models.Item'
